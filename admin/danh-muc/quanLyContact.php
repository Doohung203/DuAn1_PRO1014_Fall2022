  ...
  <section class="admin mx-auto items-center ">
    ...
    <section class="manage grid grid-cols-5 gap-4 my-4 ">
      ...
      <section class="col-span-4 border-2-sm bg-gray-200 shadow-inherit">
        <h2 class="py-6 font-bold text-3xl text-center text-gray-600 uppercase">Contact</h2>
          ...
          <table class="w-full texts-sm text-left p-3 ">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
              <tr>
                ...
                <!-- <th class="py-3 px-6"> <a href="quanLyBinhLuan/add.php" class="border rounded-md px-4 py-2 bg-green-500 text-center text-white font-bold hover:text-green-400 hover:bg-white hover:border-red-300"></a> </th> -->
