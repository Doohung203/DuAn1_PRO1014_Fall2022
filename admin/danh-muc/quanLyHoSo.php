...
$bacsi = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <div class="flex justify-between items-center my-10 ">
                <div class="profile flex">
                  <div class="notification">
                    <a class="" href=""><i class="fa-2x p-8 fa-solid fa-bell"></i></i></a>
                  </div>
                  <div class="message">
...
<div class="menu  leading-10 bg-[#30536D]">
  ...
  <section class="col-span-4 border-2-sm bg-gray-200 shadow-inherit">
      <h2 class="py-6 font-bold text-3xl text-center text-gray-600 uppercase">Quản lý hồ sơ </h2>
