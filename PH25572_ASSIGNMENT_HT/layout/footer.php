<footer>
            ...
            <section class="subscribe">
                <div class="img">
                    <img src="images/sub-logo.png" alt="" class="w-full">
                </div>
                <div class="sub-text">
                    <h2 class="text-xl"><strong>Đăng ký nhận tin</strong></h2>
                    <span>Đăng ký để nhận những chương trình khuyến mại hot nhất của Hoàng Hà Mobile</span>
                </div>
                <div class="sub-email">
                    <form action="">
                        <div class="border">
            ...
            <section class="container">
                <div class="text-footer">
                    <span>© 2020. CÔNG TY CỔ PHẦN XÂY DỰNG VÀ ĐẦU TƯ THƯƠNG MẠI HOÀNG HÀ. MST: 0106713191. (Đăng ký lần
                        đầu: Ngày 15 tháng 12 năm 2014, Đăng ký thay đổi ngày 29/12/2020)</span>
                    <strong>GP số 426/GP-TTĐT do sở TTTT Hà Nội cấp ngày 22/01/2021</strong>
                    <small>Địa chỉ: 26 Phù Đổng Thiên Vương, P. Phạm Đình Hổ, Q. Hai Bà Trưng, Hà Nội. Điện thoại:
                        1900.2091. Chịu trách nhiệm nội dung: Hoàng Ngọc Chiến.</small>
                    <small>Designed by: <b>DuyTan</b></small>
                </div>
            </section>
        </footer>
    </body>
